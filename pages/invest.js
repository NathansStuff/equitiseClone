...
export default function Invest({ companies: initialCompanies }) {
  ...
  return (
    <PageLayout
      title='INVEST IN'
      subtitle='A Range of Exciting Offers'
      content='From equity crowdfunds to IPOs and wholesale offers, we have
